// ==========================================
// 🚀 APPLICATION CONTROLLER (สมองกลควบคุมหลัก - อัปเกรดระบบ 3 รูปภาพ)
// ==========================================
...
// ==========================================
// 📊 ระบบหน้ารายงานสรุปแดชบอร์ด (เพิ่มระบบรองรับ 3 รูปภาพ)
// ==========================================
...
function renderReportTable(items) {
    ...
    items.forEach((tx) => {
        ...
        // 🛠️ ปรับปรุง: ระบบแยกเงื่อนไขการสร้างปุ่มรองรับไฟล์ภาพหลักฐานสูงสุด 3 รูปแบบพร้อมกัน
        ...
        // ✨ รูปภาพที่ 3: ปุ่มเปิดหลักฐานรูปสินค้า/หน้างานเพิ่มเติมคาร์โก้ชิ้นใหม่ตามกำหนด
        ...
        let nameBadge = (tx.is_new_customer && tx.is_new_customer.indexOf("認知") !== -1 || tx.is_new_customer && tx.is_new_customer.indexOf("ใช่") !== -1) ? `<span class="badge bg-danger text-white py-1 px-2 me-1 fs-6">ใหม่</span> ${tx.customer_name}` : tx.customer_name;
